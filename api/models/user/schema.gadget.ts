...
// This file describes the schema for the "user" model, go to https://backup-njx.gadget.app/edit to view/edit your model in Gadget
...
export const schema: GadgetModel = {
  ...
  fields: {
    Seller: {
      type: "hasOne",
      child: { model: "Seller", belongsToField: "User_Seller_Match" },
      storageKey: "0ZZ_oAvwo1u0",
    },
    email: {
      type: "email",
